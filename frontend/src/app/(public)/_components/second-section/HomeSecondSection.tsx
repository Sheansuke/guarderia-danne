...
export const HomeSecondSection = () => {
  return (
    <div className="p-4 flex flex-col items-center text-[2rem]">
      <h2 className="text-orange-950 font-bold md:text-[2rem] text-[1.8rem] text-opacity-70 ">¡Tenemos clases para tu peque!</h2>

      <div className="flex-col flex md:flex-row md:gap-16 gap-10 mt-24">
